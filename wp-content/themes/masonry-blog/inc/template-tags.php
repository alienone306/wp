...
if( ! function_exists( 'masonry_blog_full_image' ) ) {
	...
	function masonry_blog_full_image() {
		...
		?>
		<img width="<?php echo esc_attr( $thumbnail_attachment[1] ); ?>" height="<?php echo esc_attr( $thumbnail_attachment[2] ); ?>" src="data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs=" alt="<?php masonry_blog_thumbnail_alt_text(); ?>" class="mb-thumbnail lazy-img" data-src="<?php echo esc_url( get_the_post_thumbnail_url( get_the_ID(), 'full' ) ); ?>" data-srcset="<?php echo esc_attr( $thumbnail_srcset ); ?>" sizes="<?php echo esc_attr( $thumbnail_sizes ); ?>">
		<?php
	}
}
...
if( ! function_exists( 'masonry_blog_thumbnail_one_image' ) ) {
	...
	function masonry_blog_thumbnail_one_image() {
		...
		?>
		<img width="<?php echo esc_attr( $thumbnail_attachment[1] ); ?>" height="<?php echo esc_attr( $thumbnail_attachment[2] ); ?>" src="data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs=" alt="<?php masonry_blog_thumbnail_alt_text(); ?>" class="mb-thumbnail img-lazyload" data-src="<?php echo esc_url( get_the_post_thumbnail_url( get_the_ID(), 'masonry-blog-thumbnail-one' ) ); ?>" data-srcset="<?php echo esc_attr( $thumbnail_srcset ); ?>" sizes="<?php echo esc_attr( $thumbnail_sizes ); ?>">
		<?php
	}
}
...
if( ! function_exists( 'masonry_blog_thumbnail_two_image' ) ) {
	...
	function masonry_blog_thumbnail_two_image() {
		...
		?>
		<img width="<?php echo esc_attr( $thumbnail_attachment[1] ); ?>" height="<?php echo esc_attr( $thumbnail_attachment[2] ); ?>" src="data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs=" alt="<?php masonry_blog_thumbnail_alt_text(); ?>" class="mb-thumbnail img-lazyload" data-src="<?php echo esc_url( get_the_post_thumbnail_url( get_the_ID(), 'masonry-blog-thumbnail-two' ) ); ?>" data-srcset="<?php echo esc_attr( $thumbnail_srcset ); ?>" sizes="<?php echo esc_attr( $thumbnail_sizes ); ?>">
		<?php
	}
}

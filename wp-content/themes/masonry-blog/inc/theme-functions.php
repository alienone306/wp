        ...
        <div class="comment-author vcard">
            <div class="comment-author-avatar">
                ...
                if ( $args['avatar_size'] != 0 ) {
                    ?>
                    <img class="avatar img-lazyload" src="data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs=" alt="<?php echo esc_attr( get_comment_author() ); ?>" data-src="<?php echo esc_url( get_avatar_url( $comment->user_id, ['size' => '75'] ) ); ?>" height="75" width="75">
                    <?php
                } 
                ?>
            </div>

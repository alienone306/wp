		...
		<div class="row">
			<div class="col-md-2 col-lg-2">
				<div class="author-avatar">
					<img class="avatar img-lazyload" src="data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs=" alt="<?php echo esc_attr( get_the_author_meta( 'display_name' ) ); ?>" data-src="<?php echo esc_url( get_avatar_url( get_the_author_meta( 'ID' ), ['size' => '300'] ) ); ?>" height="300" width="300">
				</div>
			</div>

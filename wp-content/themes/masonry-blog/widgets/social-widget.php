					...
					<ul>
						...
						if( $layout == 'layout_1' ) {
							...
							if( !empty( $youtube_link ) ) {
								?>
								<li>
									<a class="social-link-youtube" href="<?php echo esc_url( $youtube_link ); ?>"><span><?php esc_html_e( 'Youtube', 'masonry-blog' ); ?></span><span class="social-icon"><i class="fa fa-youtube" aria-hidden="true"></i></span></a>
								</li>
								<?php
							}

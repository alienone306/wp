	            	...
	            	if( $thumbnail_attachment ) {
						...
						<div class="author-thumbnail">
							<a href="<?php if( !empty( $button_link ) ) { echo esc_url( $button_link ); } ?>" class="author-image">
								<img width="<?php echo esc_attr( $thumbnail_attachment[1] ); ?>" height="<?php echo esc_attr( $thumbnail_attachment[2] ); ?>" src="data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs=" alt="<?php masonry_blog_thumbnail_alt_text(); ?>" class="mb-thumbnail img-lazyload" data-src="<?php echo esc_url( $thumbnail_attachment_src[0] ); ?>" data-srcset="<?php echo esc_attr( $thumbnail_srcset ); ?>" sizes="<?php echo esc_attr( $thumbnail_sizes ); ?>">
							</a>
						</div>
						<?php
					}

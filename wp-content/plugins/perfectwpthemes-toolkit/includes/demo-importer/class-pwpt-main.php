...
class PWPT_Main {
	...
	public function display_plugin_page() {
        ...
        <div class="PWPT__intro-notice notice notice-warning is-dismissible">
            <p><?php esc_html_e( 'Before you begin, make sure all the required plugins are activated.', 'perfectwpthemes-toolkit' ); ?></p>
        </div>
        <div class="wrap">
            ...
            <div class="PWPT_about-description">
            	<p><?php esc_html_e( 'It will allow you to quickly edit everything instead of creating content from scratch.', 'perfectwpthemes-toolkit' ); ?></p>
				<p><?php esc_html_e( 'When you import the data, the following things might happen:', 'perfectwpthemes-toolkit' ); ?></p>

				<ul>
					<li><?php esc_html_e( 'No existing posts, pages, categories, images, custom post types or any other data will be deleted or modified.', 'perfectwpthemes-toolkit' ); ?></li>
					<li><?php esc_html_e( 'Posts, pages, images, widgets, menus and other theme settings will get imported.', 'perfectwpthemes-toolkit' ); ?></li>
				</ul>
			</div>
			...
			if ( 0 < count( $this->import_files ) ) : ?>
                <div class="PWPT__multi-select-import">
                	...
                	<?php else : ?>
                		<h2><?php esc_html_e( 'Select any one demo to import from the demos below:', 'perfectwpthemes-toolkit' ); ?></h2>
                	<?php endif; ?>
                ...
                <p><?php esc_html_e( 'Sometimes of the elements may not be imported, due to some errors. So manually configure them.', 'perfectwpthemes-toolkit' ); ?></p>
				<?php 
			endif;
			?>
        </div>

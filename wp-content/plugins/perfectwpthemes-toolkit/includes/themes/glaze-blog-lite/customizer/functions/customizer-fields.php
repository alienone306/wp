...
if( ! function_exists( 'perfectwpthemes_toolkit_section_declaration' ) ) {
	...
	function perfectwpthemes_toolkit_section_declaration() {
		...
		$sections = array(
			...
			array(
				'id' => 'site_color',
				'title' => esc_html__( 'Site Color', 'perfectwpthemes-toolkit' ),
				'description' => '',
				'panel' => '',
				'priority' => 4,
			),
...
/*******************************************************************************************************
************************************* Color Control Fields Declaration *********************************
*******************************************************************************************************/
perfectwpthemes_toolkit_add_alpha_color_field( 'primary_color', esc_html__( 'Primary Color', 'perfectwpthemes-toolkit' ), '', '', 'site_color' );
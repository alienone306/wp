(function( $ ) {
	...
	wp.customize.bind( 'ready', function() {
		...
		customizer_label( 'glaze_blog_lite_field_display_blog_social_share', 'Share On Pages' );
		customizer_label( 'glaze_blog_lite_field_share_on_facebook', 'Share On Sites' );

		/**
		 *	Alpha Color Picker Custom Control's Script
		 */

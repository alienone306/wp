 ...
 * @since 1.0.0
 */
class Posts_Style_13 extends \Elementor\Widget_Base {

	public function get_name() {
		return 'drozd-posts-style-13';
	}

	public function get_title() {
		return __( 'Posts Style 13', 'drozd-addons-for-elementor' );
	}

	public function get_icon() {
		return 'drozd-icon-posts-style-13';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .title-wrap .title .header' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .title-wrap .title .header' => 'background: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-13 .title-wrap .title .header',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .title-wrap .title .header' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .title-wrap .title .header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .title-wrap .title' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .title-wrap .title' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .title-wrap' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'left',
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap  .meta-info' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap .thumbnail .tags a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap .thumbnail .tags a' => 'background: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap .thumbnail .tags a',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap .thumbnail .tags a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap .thumbnail .tags a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap .thumbnail .tags a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap .meta-info .meta-align .title h3 a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap .meta-info .meta-align .title h3 a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap .meta-info .meta-align .author-date .author a' => 'color: {{VALUE}}',
				],
				'condition' => array(
					'show_author' => 'yes',
				),
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap .meta-info .meta-align .author-date .author a',
				'condition' => array(
					'show_author' => 'yes',
				),
			]
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap .meta-info .meta-align .author-date' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap .meta-info .meta-align .author-date',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-13 .posts-wrap .col-wrap:hover .meta-info .meta-align .title h3 a' => 'color: {{VALUE}}',
				],
			]
		);
	...
	protected function render() {
		...
		?>
		<div class="drozd-posts-style-13">

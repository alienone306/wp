 ...
 * @since 1.0.0
 */
class Posts_Style_6 extends \Elementor\Widget_Base {

	public function get_name() {
		return 'drozd-posts-style-6';
	}

	public function get_title() {
		return __( 'Posts Style 6', 'drozd-addons-for-elementor' );
	}

	public function get_icon() {
		return 'drozd-icon-posts-style-6';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .title-wrap .title .header' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .title-wrap .title .header' => 'background: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-6 .title-wrap .title .header',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .title-wrap .title .header' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .title-wrap .title .header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .title-wrap .title' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .title-wrap .title' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .title-wrap' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Title, Author and Date', 'drozd-addons-for-elementor' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .posts-wrap' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .posts-wrap .col-wrap .meta-info .meta-align .title h3 a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-6 .posts-wrap .col-wrap .meta-info .meta-align .title h3 a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .posts-wrap .col-wrap .meta-info .meta-align .author-date .author a' => 'color: {{VALUE}}',
				],
				'condition' => array(
					'show_author' => 'yes',
				),
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-6 .posts-wrap .col-wrap .meta-info .meta-align .author-date .author a',
				'condition' => array(
					'show_author' => 'yes',
				),
			]
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .posts-wrap .col-wrap .meta-info .meta-align .author-date' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-6 .posts-wrap .col-wrap .meta-info .meta-align .author-date',
			]
		);
		...
		$this->add_control(
			'style_set_indents',
			[
				'label' => __( 'Set the indents', 'drozd-addons-for-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			'block_margin_bottom',
			[
				'label' => __( 'Margin Bottom', 'drozd-addons-for-elementor' ) . ' (px)',
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .posts-wrap .col-wrap:not(:last-child) .meta-info' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Padding Bottom', 'drozd-addons-for-elementor' ) . ' (px)',
				'type' => \Elementor\Controls_Manager::SLIDER,
				'default' => [
					'unit' => 'px',
				],
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .posts-wrap .col-wrap:not(:last-child) .meta-info' => 'padding-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .posts-wrap .col-wrap:not(:last-child) .meta-info' => 'border-color: {{VALUE}}',
				],
			]
		);

		$this->add_responsive_control(
			'block_border_width_bottom',
			[
				'label' => __( 'Border Width', 'drozd-addons-for-elementor' ) . ' (px)',
				'type' => \Elementor\Controls_Manager::SLIDER,
				'default' => [
					'unit' => 'px',
				],
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .posts-wrap .col-wrap:not(:last-child) .meta-info' => 'border-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-6 .posts-wrap .col-wrap:hover .meta-info .meta-align .title h3 a' => 'color: {{VALUE}}',
				],
			]
		);

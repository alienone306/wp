 ...
 * @since 1.0.3
 */
class Posts_Style_14 extends \Elementor\Widget_Base {

	public function get_name() {
		return 'drozd-posts-style-14';
	}

	public function get_title() {
		return __( 'Posts Style 14', 'drozd-addons-for-elementor' );
	}

	public function get_icon() {
		return 'drozd-icon-posts-style-14';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .title-wrap .title .header' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .title-wrap .title .header' => 'background: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-14 .title-wrap .title .header',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .title-wrap .title .header' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .title-wrap .title .header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .title-wrap .title' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .title-wrap .title' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .title-wrap' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .col-wrap .meta-info .meta-align .tags a' => 'color: {{VALUE}}',
				],
				'condition' => array(
					'show_tags' => 'yes',
				),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .col-wrap .meta-info .meta-align .tags a' => 'background: {{VALUE}}',
				],
				'condition' => array(
					'show_tags' => 'yes',
				),
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-14 .col-wrap .meta-info .meta-align .tags a',
				'condition' => array(
					'show_tags' => 'yes',
				),
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .col-wrap .meta-info .meta-align .tags a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => array(
					'show_tags' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .col-wrap .meta-info .meta-align .tags a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => array(
					'show_tags' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .col-wrap .meta-info .meta-align .tags a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => array(
					'show_tags' => 'yes',
				),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .col-wrap .meta-info .meta-align .title h3 a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-14 .col-wrap .meta-info .meta-align .title h3 a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .col-wrap .meta-info .meta-align .author-date' => 'color: {{VALUE}}',
					'{{WRAPPER}} .drozd-posts-style-14 .col-wrap .meta-info .meta-align .author-date a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .drozd-posts-style-14 .col-wrap .meta-info .meta-align .author-date',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .col-wrap:hover .meta-info .meta-align .tags a' => 'color: {{VALUE}}',
				],
				'condition' => array(
					'show_tags' => 'yes',
				),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .drozd-posts-style-14 .col-wrap:hover .meta-info .meta-align .tags a' => 'background: {{VALUE}}',
				],
				'condition' => array(
					'show_tags' => 'yes',
				),
	...
	protected function render() {
		...
		?>
		<!--Posts Style 14-->
		<div class="drozd-posts-style-14">
			...
			<div class="wrapper-posts posts-wrap">
				...
				foreach( $get_posts as $post ) :
					...
					$image_cropped_size = 'drozd-post-style-14-medium';

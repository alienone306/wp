...
(function (factory, window, document) {
    ...
    var Mark = function () {
        ...
        _createClass(Mark, [{
            ...
            value: function wrapRangeInTextNode(node, start, end, cnt) {
                var hEl = !this.opt.element ? "mark" : this.opt.element,
                    startNode = node.splitText(start),
                    ret = startNode.splitText(end - start);
                var repl = document.createElement(hEl);

                if (this.opt.dataAttribute) {
                ...
                if (this.opt.counter) {
                    repl.setAttribute("data-cnt", cnt);
                    repl.setAttribute("class", this.opt.className + ' mark_counter');
                }
            ...
            value: function wrapRangeInMappedTextNode(dict, start, end, filterCb, eachCb) {
                ...
                dict.nodes.every(function (n, i) {
                    ...
                    if (typeof sibl === "undefined" || sibl.start > start) {
                        ...
                        cnt++;
                        n.node = _this5.wrapRangeInTextNode(n.node, s, e, cnt);
                        n.node.position = start;
                ...
                this.getTextNodes(function (dict) {
                    dict.nodes.forEach(function (node) {
                        ...
                        while ((match = regex.exec(node.textContent)) !== null && match[matchIdx] !== "") {
                            ...
                            cnt++;
                            node = _this6.wrapRangeInTextNode(node, pos, pos + match[matchIdx].length, cnt);
                    ...
                    handler = function handler(kw) {
                        ...
                        _this10[fn](regex, 1, function (term, node) {
                            ...
                            if (kwArr[kwArrLen - 1] === kw) {
                                _this10.opt.done(totalMatches, positions);
                            } else {
    ...
    $.fn.sq_mark = function (sv, opt) {
        new Mark(this.get()).mark(sv, opt);
        return this;
    };
    $.fn.sq_markRegExp = function (regexp, opt) {
        new Mark(this.get()).markRegExp(regexp, opt);
        return this;
    };
    $.fn.sq_markRanges = function (ranges, opt) {
        new Mark(this.get()).markRanges(ranges, opt);
        return this;
    };
    $.fn.sq_unmark = function (opt) {

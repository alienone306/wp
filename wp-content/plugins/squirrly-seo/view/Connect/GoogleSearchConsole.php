...
<div class="ga-connect-place">
        ...
        <div class="card col-sm-12 bg-googlesc px-0 py-0 mx-0">
            <div class="card-heading my-2">
                <h3 class="card-title text-white">
                    <div class="google-icon fa fa-google mx-2"></div><?php echo __('Google Search Console', _SQ_PLUGIN_NAME_); ?>
                </h3>
            </div>
    ...
    <?php } else { ?>
        <div class="col-sm-12 bg-googlesc py-2 mb-2">
            <div class="col-sm-12">
                <h4 class="text-white py-3"><?php echo __('Connect this blog to Google Search Console', _SQ_PLUGIN_NAME_); ?></h4>
                <p><?php echo __("Connect Google Search Console and get traffic insights for your website on each Audit", _SQ_PLUGIN_NAME_) ?></p>
            </div>

...
class SQ_Models_BulkSeo {
    ...
    public function init() {
        ...
        $this->_task_categories = array(
            'metas' => __('METAs', _SQ_PLUGIN_NAME_),
            'opengraph' => __('Open Graph', _SQ_PLUGIN_NAME_),
            'twittercard' => __('Twitter Card', _SQ_PLUGIN_NAME_),
            'visibility' => __('Visibility', _SQ_PLUGIN_NAME_),
        );
    ...
    public function getAssistantCategories($hash) {
        return json_decode(json_encode($this->_assistant_categories[$hash]));
    }

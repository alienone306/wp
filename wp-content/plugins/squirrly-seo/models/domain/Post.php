...
class SQ_Models_Domain_Post extends SQ_Models_Abstract_Domain {
    ...
    public function getSocials() {
        if (!isset($this->_socials)) {
            $this->_socials = json_decode(json_encode(SQ_Classes_Helpers_Tools::getOption('socials')));
        }
    ...
    public function getSq_adm() {
        ...
        if (!isset($this->_sq_adm) && isset($this->_post_type) && $this->_post_type <> '') {
            if (is_user_logged_in()) {
                $this->_sq_adm = SQ_Classes_ObjController::getClass('SQ_Models_Qss')->getSqSeo($this->_hash, $this->ID);

...
class SQ_Models_Menu {
    ...
    public function getMainMenu() {
        $menu = array(
            'sq_dashboard' => array(
                'title' => ((SQ_Classes_Helpers_Tools::getOption('sq_api') == '') ? __('First Step', _SQ_PLUGIN_NAME_) : __('Dashboard', _SQ_PLUGIN_NAME_)) ,
                'description' => ucfirst(_SQ_NAME_) . __(' Dashboard', _SQ_PLUGIN_NAME_),
                'parent' => 'sq_dashboard',
                'capability' => 'edit_posts',
                'function' => array(SQ_Classes_ObjController::getClass('SQ_Controllers_Dashboard'), 'init'),
                'icon' => ''
            ),
            'sq_research' => array(

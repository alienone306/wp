...
class SQ_Models_Frontend {
    ...
    public function loadSeoLibrary() {
        if ($this->_post && $this->_post->sq->doseo) {
            //load all services
            if (SQ_Classes_Helpers_Tools::getOption('sq_auto_metas')) {
                if (SQ_Classes_Helpers_Tools::getOption('sq_auto_title')) SQ_Classes_ObjController::getClass('SQ_Models_Services_Title');
                if (SQ_Classes_Helpers_Tools::getOption('sq_auto_description')) SQ_Classes_ObjController::getClass('SQ_Models_Services_Description');
                if (SQ_Classes_Helpers_Tools::getOption('sq_auto_keywords')) SQ_Classes_ObjController::getClass('SQ_Models_Services_Keywords');
                if (SQ_Classes_Helpers_Tools::getOption('sq_auto_canonical')) SQ_Classes_ObjController::getClass('SQ_Models_Services_Canonical');
                if (SQ_Classes_Helpers_Tools::getOption('sq_auto_canonical')) SQ_Classes_ObjController::getClass('SQ_Models_Services_PrevNext');
                if (SQ_Classes_Helpers_Tools::getOption('sq_auto_noindex')) SQ_Classes_ObjController::getClass('SQ_Models_Services_Noindex');
                if (SQ_Classes_Helpers_Tools::getOption('sq_auto_favicon')) SQ_Classes_ObjController::getClass('SQ_Models_Services_Favicon');
                if (SQ_Classes_Helpers_Tools::getOption('sq_auto_dublincore')) SQ_Classes_ObjController::getClass('SQ_Models_Services_DublinCore');
            }
            ...
            if (SQ_Classes_Helpers_Tools::getOption('sq_auto_jsonld')) SQ_Classes_ObjController::getClass('SQ_Models_Services_JsonLD');
        }
    }
    ...
    public function getAdvancedMeta($post_id, $meta = null) {
        return SQ_Classes_ObjController::getClass('SQ_Models_Qss')->getSqSeo(null, $post_id, $meta);
    }

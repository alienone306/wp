...
class SQ_Models_Assistant {
    ...
    public function getAssistant($category_name = 'sq_research') {
        ...
        if ($tasks = $this->parseAllTasks($category_name)) {
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content bg-light">
                            <div class="modal-header">
                                <h4 class="modal-title">' . __('Task Details', _SQ_PLUGIN_NAME_) . ':</h4>
                            ...
                            <div class="checker col-sm-3 row m-0 p-0 sq_save_ajax">
                                <div class="col-sm-12 p-0 sq-switch sq-switch-xxs text-right">
                                    <label for="sq_ignore" class="ml-2 text-black-50 font-weight-normal">' . __('active task', _SQ_PLUGIN_NAME_) . '</label>
    ...
    public function getTasks($category_name) {
        ...
        if (SQ_Classes_Helpers_Tools::getOption('sq_assistant')) {
            $tasks['sq_dashboard'] = array(
                'all_research' => array(
                    'title' => __("Complete Research Tasks", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Go to the Research section of Squirrly SEO. %s Look to the right of the screen and turn those RED bullets from Red to Green. Click on each element and you'll find out what you need to do to complete the task and turn it Green.", _SQ_PLUGIN_NAME_), '<br /><br />'),
                    'function' => 'checkAllResearch',
                ),
                'all_assistant' => array(
                    'title' => __("Complete Live Assistant Tasks", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Go to the Live Assistant section of Squirrly SEO. %s Look to the right of the screen and turn those RED bullets from Red to Green. Click on each element and you'll find out what you need to do to complete the task and turn it Green.", _SQ_PLUGIN_NAME_), '<br /><br />'),
                    'function' => 'checkAllAssistant',
                ),
                'all_settings' => array(
                    'title' => __("Complete SEO Settings Tasks", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Go to the SEO Settings section of Squirrly SEO. Click on the METAs section. You'll see tasks appearing at the right of the screen. %s Look to the right of the screen and turn those RED bullets from Red to Green. Click on each element and you'll find out what you need to do to complete the task and turn it Green.", _SQ_PLUGIN_NAME_), '<br /><br />'),
                    'function' => 'checkAllSettings',
                ),
//                'all_focuspage' => array(
//                    'title' => __("Add Your First Focus Page", _SQ_PLUGIN_NAME_),
//                    'description' => sprintf(__("Focus Pages help you systematically take pages from \"Never Found\" to \"Always Found\" on the first page of Google. %sThey force you to choose a keyword for which you actually have chances of being ranked in TOP 10 by Google, it helps you avoid any visibility issues AND then it guides you step by step to ranking that page to top 10.%sIt does all this according the the specific characteristics of your page. Everything you'll see there will be 100% relevant for THAT page. No two pages will be treated the same (except in case of some weird coincidence).%sTurn elements from Red to Green, and you will win.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />', '<br /><br />'),
//                    'function' => 'checkAllFocusPages',
//                ),
                'all_audits' => array(
                    'title' => __("Complete SEO Audit Tasks", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Go to the SEO Audit section of Squirrly SEO.%sLook to the right of the screen and turn those RED bullets from Red to Green. Click on each element and you'll find out what you need to do to complete the task and turn it Green.", _SQ_PLUGIN_NAME_), '<br /><br />'),
                    'function' => 'checkAllAudits',
                ),
                'all_rankings' => array(
                    'title' => __("Complete Ranking Tasks", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Go to the Ranking section of Squirrly SEO. %sLook to the right of the screen and turn those RED bullets from Red to Green. Click on each element and you'll find out what you need to do to complete the task and turn it Green.", _SQ_PLUGIN_NAME_), '<br /><br />'),
                    'function' => 'checkAllRankings',
                ),
            );
            $tasks['sq_research'] = array(
                'do_research' => array(
                    'title' => __("Do Keyword Research", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Use Research - Find Keywords to perform your very first keyword research for this website using Squirrly SEO. %s It will guide through the 3 important steps of performing a research. %s Just follow the steps.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />'),
                    'function' => 'checkKeywordResearch',
                ),
                'add_briefcase' => array(
                    'title' => __("Add Keywords in Briefcase", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Use the Briefcase feature to organize and manage your portfolio of keywords. %s You'll need to know and document the keywords that you'll be using throughout your WordPress site. %s This will help you keep a clear SEO Strategy or it can help you form a SEO Strategy. It will also help you focus and you'll get to see when you're spreading yourself too thin. %s Add your first keywords (that you've researched using the Keyword Research tool) to Briefcase. Only add keywords that you will want to work on at some point in the future and which are on-point with your strategy.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />', '<br /><br />'),
                    'function' => 'checkKeywordBriefcase',
                ),
                'add_labels' => array(
                    'title' => __("Create Labels for Keywords", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Organize your keywords by using Labels for the keywords you've stored in Briefcase. %s There are many ways to use this: from Customer Journey labels, to direct or indirect labels, to core keywords or secondary keywords ... and so on. You can get super creative with this. %s We have a very important blog post you can read for this http://fourhourseo.com/pro-course-6-how-to-organize-and-manage-your-keyword-portfolio/ %s Just add your first label to complete this task.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />', '<br /><br />'),
                    'function' => 'checkLabelBriefcase',
                ),
                'add_keyword_label' => array(
                    'title' => __("Add Keywords to Labels", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Now that you've created your first label, you should label one of your stored keywords using that label. %s Go to Briefcase. Move your mouse over the row containing your desired keyword. The 3 vertical dots button appears. %s Move your mouse over it and a menu will show. Click on Assign Label. %s Then, assign a label to your keyword in order to complete this task.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />', '<br /><br />'),
                    'function' => 'checkKeywordLabels',
                ),
                'add_keyword_serp' => array(
                    'title' => __("Send Keywords to Rank Checker", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Now that you (hopefully) have keywords added to your Briefcase, go look at one of your keywords. Move the mouse over the row with your desired keyword. %s You will see a button with 3 vertical dots appear to the right of the row. %s Get your mouse cursor over that button. A menu shows. Click on Send to Rank Checker. %s That's it. Now Squirrly SEO's rank checker feature will start tracking your position in Google for that keyword that is part of your SEO strategy.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />', '<br /><br />'),
                    'function' => 'checkKeywordSerp',
                ),
            );
            $tasks['sq_assistant'] = array(
                'sla_optimize' => array(
                    'title' => __("Optimize Using Live Assistant", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Optimize your first Page or Article using the SEO Live Assistant (SLA) feature from Squirrly SEO. %s You can either Edit an existing post or create a new post. (You have your Live Assistant where you have your WP Editor)%sThe SEO Live Assistant is like having a SEO Consultant near you, whispering in your ear exactly what you have to do to get a 100% optimized article or page.%sYou can try the DEMO first, by clicking on the Demo Post button. It's safe to break anything in the SEO of that page, because it never gets indexed by Google, since it's a DEMO. It's an easy way to learn your way around it.", _SQ_PLUGIN_NAME_), '<br />', '<br />', '<br />', '<br />'),
            ...
            $tasks['sq_seosettings'] = array(
                ...
                'setup_jsonld' => array(
                    'title' => __("Activate JSON-LD", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("JSON-LD Structured Data needs to be activated. %s The Duplicate Removal feature of Squirrly SEO will make sure that if you have more than one JSON-LD definition inside the source code of any URL, the definition created by Squirrly SEO will be the only one that remains. %s Make sure you setup all the information about your Organization or your Personal Brand here. %s To finish all the JSON-LD related setup, also visit the Social Media section of our Settings page and write in your social media profiles for this site. %s Then, at URL-level you will be able to add custom JSON-LD if you're an advanced user.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />', '<br /><br />', '<br /><br />'),
                    'function' => 'checkSettingsJsonld',
                ),
                'setup_og' => array(
                    'title' => __("Activate Open Graph", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Go to the Social Media section.%sActivate Open Graph. (switch the toggle to ON) %s The Open Graph will help you control the way your posts look when people share your URLs to social media sites like Facebook and LinkedIN. %s It will also make your social media posts look great and gain you clicks to your site.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />', '<br /><br />'),
                    'function' => 'checkSettingsSocialOG',
                ),
                'setup_twc' => array(
                    'title' => __("Activate Twitter Card", _SQ_PLUGIN_NAME_),
                ...
                'setup_fpixel' => array(
                    'title' => __("Activate Facebook Pixel", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Go to the Tracking Tools section of the settings and add your Facebook Pixel ID. %s Make sure you click Save Settings after you do that. %s Do this, and Facebook will start tracking user actions on your site, so you can later retarget them with ads.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />'),
                    'function' => 'checkSettingsFacebookPixel',
                ),
                'setup_webmasters' => array(
                    'title' => __("Connect the Webmasters", _SQ_PLUGIN_NAME_),
            ...
            $tasks['sq_audits'] = array(
                'ga_connect' => array(
                    'title' => __("Connect Google Analytics", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Integrate Google Analytics with Squirrly SEO.%sFeatures like Focus Pages and the Audit need this integration, in order to work at full potential.%sGoogle Analytics is free and everyone uses it. The Audit and the Focus Pages will interpret the right data from Google Analytics for you.%sYou'll feel like an Analytics expert, without having to know a single thing about Google Analytics.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />', '<br /><br />'),
                    'function' => 'checkGAConnect',
                ),
                'gsc_connect' => array(
                    'title' => __("Connect Google Search Console", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Integrate your WordPress with Google Search Console, using Squirrly SEO.%sThis integration is more than just setting the meta code for it. It will connect your WP to the API of Google's service and enable info such as Impressions, Clicks, Average Ranking Position to be collected.%sMore importantly, you'll be able to update all the info that Google has about your site, directly from your Squirrly SEO Plugin.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />'),
                    'function' => 'checkGSCConnect',
                ),
                'setup_email' => array(
                    'title' => __("Set the Audit Email", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("You can customize the email to which we send the Audit reports.%sIt can be your personal email, your work email or the email of one of your collaborators.%sIt's a best practice to have the Audit sent to the person that will take charge and start correcting the problems of the site, in order to increase the score.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />'),
                    'function' => 'checkAuditEmail',
                ),
                'audit_score_60' => array(
                    'title' => __("Get your score over 60", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("True website marketing performance happens after your Audit score gets to over 84.%sHowever, you need to start with smaller steps. For now, focus on getting a score of over 60.%sLook at the progress charts weekly and make sure you check out the Tasks section, which tells you exactly what you need to do in order to increase the score.%sWe've been testing these scores since 2013 on hundreds of thousands of websites and it's always the same: true performance happens at over 84. That's why you need to start working on this.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />', '<br /><br />'),
                    'function' => 'checkAuditScore60',
                ),
            );
            $tasks['sq_rankings'] = array(
                'add_keywords' => array(
                    'title' => __("Track your first 3 Keywords", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("SERP Checker = Search Engine Result Pages Checker. %s It checks your position on the Google Search Engine for your keywords. Also (on the Business Plan) it shows you the evolution in time for your sites' URLs for these keywords. %s Tell Squirrly SEO the first three keywords you want it to check for you, to see if you're ranking for them. %s Because you should work according to a solid SEO Strategy, you'll only be able to add keywords or remove keywords in the Ranking section from your Briefcase. %s Briefcase is your keyword organizer / manager. Find it in the Research section. Go with the mouse cursor over a keyword from briefcase -> see the 3 vertical dots -> select Send to Rank Checker", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />', '<br /><br />', '<br /><br />'),
                    'function' => 'checkRankingKeywords',
                ),
                'gsc_connect' => array(
                    'title' => __("Connect Google Search Console", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Connect Google Search Console. %s You can do that from SEO Audit -> Settings. %s It will bring information regarding Impressions and Clicks. %s Note: if you're on the free plan or the PRO plan then the Ranking Position will be displayed according to data from Google Search Console, which does not present the actual position you are on. It shows an average position that your site was lately found on. It can give you values such as 4.3 because of this. Even though your page today could be on position 7. %s The Business Plan is the only one that can give you the exact position because it uses Squirrly's private cloud servers that are working around the clock to gather the accurate, on-time and objective information about your rankings.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />', '<br /><br />', '<br /><br />'),
                    'function' => 'checkGSCConnect',
                ),
                'top_ranking' => array(
                    'title' => __("Get 1 Keyword to the first page of Google", _SQ_PLUGIN_NAME_),
                    'description' => sprintf(__("Start with a small task. Get 1 keyword to the first page of Google. %s Select a good keyword (using our Keyword Research tool). %s Create an amazing page for it (if you don't already have one). %s Add the page to Focus Pages in Squirrly SEO. %s Turn the RED lights to Green in Focus Pages and see your rankings increase over time. %s If you continue working on those tasks and turning elements to green you'll complete this task.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />', '<br /><br />', '<br /><br />', '<br /><br />'),
                    'function' => 'checkRankingTop',
                ),
//                'setup_frequency' => array(
//                    'title' => __("Select a Ranking Frequency above 0", _SQ_PLUGIN_NAME_),
//                    'description' => sprintf(__("The default setting is 0. %s Go to Ranking - Settings and set the Ranking Frequency to anything above 0. %s The Ranking Frequency setting tells Squirrly SEO how many keywords it should check rankings for every single day.", _SQ_PLUGIN_NAME_), '<br /><br />', '<br /><br />'),
...
//                ),
    ...
    public function parseAllTasks($category_name) {
        ...
        if (!empty($tasks)) {
            ...
            foreach ($tasks as $name => &$task) {
                ...
                $task['error_message'] = (!$task['active'] ? __('You chose to ignore this task. Click to activate it.', _SQ_PLUGIN_NAME_) : '');
            }
    ...
    /********************************************* DASHBOARD */
    public function checkAllResearch() {
        $category_name = 'sq_research';
        $tasks = $this->getTasks($category_name);
        foreach ($tasks as $name => $task) {
            if (isset($this->_dbtasks[$category_name][$name]['completed'])) {
                if ($this->_dbtasks[$category_name][$name]['active'] && !$this->_dbtasks[$category_name][$name]['completed']) {
                    return false;
                }
            } else {
                return false;
    ...
    public function checkAllAssistant() {
        $category_name = 'sq_assistant';
        $tasks = $this->getTasks($category_name);
        foreach ($tasks as $name => $task) {
            if (isset($this->_dbtasks[$category_name][$name]['completed'])) {
                if ($this->_dbtasks[$category_name][$name]['active'] && !$this->_dbtasks[$category_name][$name]['completed']) {
    ...
    public function checkAllSettings() {
        $category_name = 'sq_seosettings';
        $tasks = $this->getTasks($category_name);
        foreach ($tasks as $name => $task) {
            if (isset($this->_dbtasks[$category_name][$name]['completed'])) {
                if ($this->_dbtasks[$category_name][$name]['active'] && !$this->_dbtasks[$category_name][$name]['completed']) {
    ...
    public function checkAllAudits() {
        $category_name = 'sq_audits';
        $tasks = $this->getTasks($category_name);
        foreach ($tasks as $name => $task) {
            if (isset($this->_dbtasks[$category_name][$name]['completed'])) {
                if ($this->_dbtasks[$category_name][$name]['active'] && !$this->_dbtasks[$category_name][$name]['completed']) {
    ...
    public function checkAllRankings() {
        $category_name = 'sq_rankings';
        $tasks = $this->getTasks($category_name);
        foreach ($tasks as $name => $task) {
            if (isset($this->_dbtasks[$category_name][$name]['completed'])) {
                if ($this->_dbtasks[$category_name][$name]['active'] && !$this->_dbtasks[$category_name][$name]['completed']) {
    ...
    public function checkKeywordResearch() {
        ...
        if (!is_wp_error($this->_stats)) {
            if (isset($this->_stats['all_researches']['value']) && $this->_stats['all_researches']['value'] > 0) {
                return true;
            }
        }
        return false;
    ...
    public function checkSLAOptimization() {
        ...
        if (!is_wp_error($this->_stats)) {
            if (isset($this->_stats['all_articles']['value']) && $this->_stats['all_articles']['value'] > 0) {
                return true;
            }
        }
        return false;
    ...
    public function checkAuditScore60() {
        $args = array();
        $args['limit'] = 1;
        if ($audits = SQ_Classes_RemoteController::getBlogAudits($args)) {
            if (!empty($audits)) {
